...
macro_rules! impl_atomic {
    ...
    (__impl bitwise $atomic:ident : $primitive:ty) => {
        ...
        impl $crate::atomic_traits::fetch::And for $atomic {
            type Type = $primitive;
        ...
        impl $crate::atomic_traits::fetch::Nand for $atomic {
            type Type = $primitive;
        ...
        impl $crate::atomic_traits::fetch::Or for $atomic {
            type Type = $primitive;
        ...
        impl $crate::atomic_traits::fetch::Xor for $atomic {
            type Type = $primitive;
    ...
    (__impl numops $atomic:ident : $primitive:ty) => {
        ...
        impl $crate::atomic_traits::fetch::Add for $atomic {
            type Type = $primitive;
        ...
        impl $crate::atomic_traits::fetch::Sub for $atomic {
            type Type = $primitive;
        ...
        cfg_if! {
            if #[cfg(any(feature = "since_1_45_0"))] {
                impl $crate::atomic_traits::fetch::Update for $atomic {
                    type Type = $primitive;
                ...
                impl $crate::atomic_traits::fetch::Max for $atomic {
                    type Type = $primitive;
                ...
                impl $crate::atomic_traits::fetch::Min for $atomic {
                    type Type = $primitive;
...
impl_atomic!(AtomicF64: f64; bitwise, numops);
impl_atomic!(AtomicF32: f32; bitwise, numops);
